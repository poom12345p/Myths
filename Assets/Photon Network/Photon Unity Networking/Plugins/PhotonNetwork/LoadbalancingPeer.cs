...
using ExitGames.Client.Photon;
    ...
    using UnityEngine;
    using System.Collections.Hashtable = ExitGames.Client.Photon.System.Collections.Hashtable;
    ...
    internal class LoadBalancingPeer : PhotonPeer
    {
        ...
        private void RoomOptionsToOpParameters(Dictionary<byte, object> op, RoomOptions roomOptions)
        {
            ...
            System.Collections.Hashtable gameProperties = new System.Collections.Hashtable();
        ...
        public virtual bool OpJoinRandomRoom(OpJoinRandomRoomParams opJoinRandomRoomParams)
        {
            ...
            System.Collections.Hashtable expectedRoomProperties = new System.Collections.Hashtable();
        ...
        /// <returns>If the operation could be sent (requires connection).</returns>
        protected internal bool OpSetPropertiesOfActor(int actorNr, System.Collections.Hashtable actorProperties, System.Collections.Hashtable expectedProperties = null, bool webForward = false)
        {
            if (this.DebugOut >= DebugLevel.INFO)
            {
        ...
        public bool OpSetCustomPropertiesOfRoom(System.Collections.Hashtable gameProperties, bool broadcast, byte channelId)
        {
        ...
        /// <returns>If the operation could be sent (has to be connected).</returns>
        protected internal bool OpSetPropertiesOfRoom(System.Collections.Hashtable gameProperties, System.Collections.Hashtable expectedProperties = null, bool webForward = false)
        {
            if (this.DebugOut >= DebugLevel.INFO)
            {
        ...
        /// </summary>
        /// <remarks>This override explicitly uses another parameter order to not mix it up with the implementation for System.Collections.Hashtable only.</remarks>
        /// <param name="eventCode">Identifies this type of event (and the content). Your game's event codes can start with 0.</param>
        /// <param name="customEventContent">Any serializable datatype (including System.Collections.Hashtable like the other OpRaiseEvent overloads).</param>
    ...
    {
        public System.Collections.Hashtable ExpectedCustomRoomProperties;
    ...
    internal class EnterRoomParams
    {
        ...
        public System.Collections.Hashtable PlayerProperties;
    ...
    public class ParameterCode
    {
        ...
        /// <summary>(249) Code for property set (System.Collections.Hashtable).</summary>
        ...
        /// <summary>(248) Code for property set (System.Collections.Hashtable).</summary>
        public const byte GameProperties = (byte)248;

        /// <summary>
        /// (251) Code for property-set (System.Collections.Hashtable). This key is used when sending only one set of properties.
    ...
    public class RoomOptions
    {
        ...
        /// </remarks>
        public System.Collections.Hashtable CustomRoomProperties;
    ...
    public bool cleanupCacheOnLeave { get { return this.cleanupCacheOnLeaveField; } set { this.cleanupCacheOnLeaveField = value; } }
    [Obsolete("Use property with uppercase naming instead.")]
    public System.Collections.Hashtable customRoomProperties { get { return this.CustomRoomProperties; } set { this.CustomRoomProperties = value; } }
    [Obsolete("Use property with uppercase naming instead.")]
